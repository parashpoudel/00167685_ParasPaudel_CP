...
class ModelRegister
{
	...
	public function registerUser(){
		$registerusersql="insert into user(username,email,password,gender,address,postalCode,phoneNumber,role) values('".$this->getUsername()."','".$this->getEmail()."','".$this->getPassword()."','".$this->getGender()."','".$this->getAddress()."','".$this->getPostalCode()."','".$this->getPhoneNumber()."','user')";
		if ($this->db->IUD($registerusersql)) {
			echo "Sucessfully user added";
		}else{
